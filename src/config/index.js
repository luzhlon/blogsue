...
const config = {
  title: "NicolasX's Blog",

  titleSuffix: 'Blogsue',

  // 界面右边，Github头像下的标语
  // 你可以写自己的座右铭
  description: '知人、晓事、修身、笃行',
  ...
  // 请申请一个clientID
  clientID: 'c04c3fe00020281c49e9',
  clientSecret: '9367b29b9f56d4583c5a7854685eaaf198e21eb4',
  /**
   * 在本博客显示的其他issue创建者
  ...
  navItem: [
    ...
    },
    {
      name: '知乎',
      icon: 'user',
      url: 'https://www.zhihu.com/people/codesoul/activities'
    }
  ],
   ...
   * 请勿插入危险的标签
   */
  blankSections: ['Write with ❤️ by Blogsue'],
